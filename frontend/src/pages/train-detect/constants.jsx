...
export const METRIC_HELP = {
  ...
  Representation: 'Saved feature representation used by the trained artifact. Public/default training uses PCA; DAE is developer-only experimental mode.',
  'Representation Components': 'Number of dimensions passed into NSA and Isolation Forest after the saved representation layer.',
  'DAE Latent Dim': 'Developer-only DAE bottleneck size. Lower values compress more aggressively.',
  'DAE Noise Std': 'Developer-only Gaussian noise level used while training the denoising autoencoder.',
  ...
  'Silhouette Score': 'Unsupervised separation score using predicted normal/anomaly groups in the saved representation space. Useful as a rough check, but limited because anomaly detection is not pure clustering.',
  ...
  'Fitted Self-Gap Radius': 'NSA self-gap radius derived from benign representation-space geometry during training.',
  'Fitted Detector Tolerance': 'V-detector self-tolerance derived from benign representation-space geometry during training.',
